...
$query = "select * from matkul where kd_matkul='$kd_matkul'";
...
if(isset($_POST['submit'])){
	...
	$query=mysql_query("update matkul set prodi='$prodi', kurikulum='$kurikulum', nm_matkul='$nm_matkul', sifat='$sifat', semester='$semester', jml_sks_T='$jml_sks_T', jml_sks_P='$jml_sks_P', jml_sks_PL='$jml_sks_PL' where kd_matkul='$kd_matkul'");
