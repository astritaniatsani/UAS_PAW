...
if(isset($_POST['submit'])){
	...
	$query=mysql_query("insert into admin values('','$nama','$username','$password','$keterangan')");
							...
							<div class=" form-grids form-grids-right">
								<div class="widget-shadow " data-example-id="basic-forms"> 
                                    ...
                                    <div class="form-group"> 
											...
											<div class="col-sm-8"><textarea name="keterangan" id="keterangan" cols="50" rows="4" class="form-control1"></textarea></div>
										</div>
										<div
											<div class="form-group"> 
				...
				<div class="agile-tables">
					<div class="w3l-table-info">
					  <h3>Tabel Data User</h3>
						...
						<tbody>
						   <?php
		$view=mysql_query("select * from admin order by id asc");
