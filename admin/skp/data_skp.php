...
<body class="dashboard-page">
	...
	<section class="wrapper scrollable">
		...
		<?php
$no=1;
$sql = "select * from surat_penelitian order by id desc";
...
?>	
		<tr>
            <td><?php echo $no ?></td>
			<td><?php echo $row['no_surat_kp'];?></td>
            ...
            <a href="rincian_skp.php?no_surat=<?php echo $row['no_surat_kp']; ?>" title="Rincian Data"><img src="../../images/ubah.png" width="15" height="15" /></a> |
<a href="hapus_skp.php?no_surat=<?php echo $row['no_surat_kp']; ?>" title="Hapus Data"><img src="../../images/hapus.png" width="15" height="15" /></a>            
            </td>
        </tr>
		<?php $no++;}?>
