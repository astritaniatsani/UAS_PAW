...
<!DOCTYPE html>
<head>
<title>SKP : Surat Keterangan Penelitian Fakultas Sains dan Teknologi</title>
...
<nav class="main-menu">
		<ul>
			...
			<li class="has-subnav">
				...
				<ul>
					<li>
					<a class="subnav-text" href="input_skp.php">
	...
	<section class="wrapper scrollable">
		...
		<section class="title-bar">
			<div class="logo">
				<h1><a href="index.html"><img src="images/logo.png" alt="" />SKP</a></h1>
			</div>
        ...
        <div class="agile-grids">	
				...
				<div class="table-heading">
					<h2>Surat Keterangan Penelitian</h2>
				</div>
							...
							<div class=" form-grids form-grids-right">
								<div class="widget-shadow " data-example-id="basic-forms"> 
									<div class="form-title">
										<h4>Laporan Surat Keterangan Penelitian :</h4>
									</div>
									<div class="form-body">
										<form class="form-horizontal" action="laporan_cetak.php" method="post"> 
											<?php include "laporanskp.php"; ?>          
