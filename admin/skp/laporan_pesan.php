...
<form id="form1" name="form1" method="post" action="laporan_cetak.php?no_surat=<?php echo $row['no_surat']; ?>" target="new">
  <br><table width="800" height="47" border="0" align="center" cellpadding="2" cellspacing="0" bgcolor="#FFFFFF">
    <tr>
      <td width="700" align="left" valign="middle" bgcolor="#9D0000" scope="col"><font color="#FFFFFFF" face="Goudy Old Style" size="3"><strong>DATA SURAT KETERANGAN PENELITIAN PERIODE :
 <input name="tglmulaitxt" type="text" id="tglmulaitxt" value="<?php echo $_POST['tglmulai'] ?>" size="10" readonly="readonly" />
  ...
  <table width="800" border="0" align="center" cellpadding="4" cellspacing="0">
    <tr>
      ...
      <th width="171" align="left" bordercolor="#8A1328" bgcolor="#00AAAA" scope="col"><div align="center">Tempat Penelitian</div></th>
      <th width="180" align="left" bordercolor="#8A1328" bgcolor="#00AAAA" scope="col"><div align="center">Tujuan Penelitian</div></th>
      <th width="133" align="left" bordercolor="#8A1328" bgcolor="#00AAAA" scope="col"><div align="center">Tanggal Penelitian</div></th>
      <th width="159" align="right" bordercolor="#8A1328" bgcolor="#00AAAA" scope="col"><div align="center">Pejabat</div></th>
    </tr>
    <?php
$no=1;
$tgl1 = substr($_POST['tglmulai'],6,4)."-".substr($_POST['tglskp'],3,2)."-". substr($_POST['tglskp'],0,2); 		
