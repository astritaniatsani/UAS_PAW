...
<!DOCTYPE html>
<head>
<title>SKP : Surat Keterangan Penelitian</title>
...
<nav class="main-menu">
		<ul>
			...
			<li class="has-subnav">
				...
				<ul>
					<li>
					<a class="subnav-text" href="input_skp">
					Input Surat Penelitian
					</a>
					</li>
					<li>
					<a class="subnav-text" href="data_skp">
	...
	<section class="wrapper scrollable">
		...
		<section class="title-bar">
			<div class="logo">
				<h1><a href="index.html"><img src="images/logo.png" alt="" />SKP></h1>
			</div>
				...
				<div class="agile-tables">
					<div class="w3l-table-info">
					  <h3>Tabel Data Surat</h3>
						...
						<tbody>
						   <?php
		$view=mysql_query("select * from surat_skp order by id asc");
...
<a href="hapus_user.php?id=<?php echo $row['id']; ?>"><img src="images/hapus.png" width="15" height="15" /></a>            
		...
		<!-- footer -->
		<div class="footer">
			<p>© 2018, SKP : Surat Keterangan Penelitian</p>
		</div>
		<!-- //footer -->
	</section>
