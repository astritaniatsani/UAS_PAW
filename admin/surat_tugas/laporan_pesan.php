...
<form id="form1" name="form1" method="post" action="laporan_cetak.php?no_surat=<?php echo $row['no_surat']; ?>" target="new">
  <br><table width="800" height="47" border="0" align="center" cellpadding="2" cellspacing="0" bgcolor="#FFFFFF">
    <tr>
      <td width="700" align="left" valign="middle" bgcolor="#9D0000" scope="col"><font color="#FFFFFFF" face="Goudy Old Style" size="3"><strong>DATA SURAT TUGAS PERIODE :
 ...
 S/D
  ...
  <table width="800" border="0" align="center" cellpadding="4" cellspacing="0">
    <tr>
      ...
      <th width="133" align="left" bordercolor="#8A1328" bgcolor="#00AAAA" scope="col"><div align="center">Tanggal Tugas</div></th>
