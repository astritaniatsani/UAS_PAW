...
<!DOCTYPE html>
<head>
<title>SKKP : Surat Keterangan Kerja Praktik</title>
...
<nav class="main-menu">
		<ul>
			...
			<li class="has-subnav">
				...
				<ul>
					<li>
					<a class="subnav-text" href="input_skkp">
					Input Surat Kerja Praktik
					</a>
					</li>
					<li>
					<a class="subnav-text" href="data_skkp">
					Data Surat Kerja Praktik
					</a>
					</li>
				</ul>
			</li>
	...
	<section class="wrapper scrollable">
		...
		<section class="title-bar">
			<div class="logo">
				<h1><a href="index.html"><img src="images/logo.png" alt="" />SKKP></h1>
			</div>
					  ...
					  <h3>Tabel Data Surat</h3>
						...
						<thead>
						  <tr>
							...
							<th>Tanggal Awal KP</th>
							<th>Tanggal Akhir KP</th>
							<th>Aksi</th>
						  </tr>
						</thead>
						<tbody>
						   <?php
		$view=mysql_query("select * from surat_tugas order by id asc");
		...
		<tr>
            ...
            <td><?php echo $row['tgl_kp'];?></td>
            <td><?php echo $row['tgl_selesaikp'];?></td>
