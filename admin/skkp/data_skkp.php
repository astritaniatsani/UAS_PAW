	...
	<section class="wrapper scrollable">
        ...
        <div class="agile-grids">	
				...
				<div class="table-heading">
					<h2>Data Surat Kerja Praktik</h2>
				</div>
		...
		<?php
$no=1;
$sql = "select * from surat_kerja_praktik order by id desc";
...
?>	
		<tr>
            <td><?php echo $no ?></td>
			<td><?php echo $row['no_surat_kkp'];?></td>
            <td><?php echo $row['pejabat'];?></td>
            <td><?php echo $row['tgl_awal_skkp'];?> sampai <?php echo $row['tgl_slsai_skkp'];?></td>
			
           
            <td class="options-width">
            <a href="rincian_skkp.php?no_surat=<?php echo $row['no_surat_kkp']; ?>" title="Rincian Data"><img src="../../images/ubah.png" width="15" height="15" /></a> |
<a href="hapus_skkp.php?no_surat=<?php echo $row['no_surat_kkp']; ?>" title="Hapus Data"><img src="../../images/hapus.png" width="15" height="15" /></a>            
            </td>
        </tr>
		<?php $no++;}?>
