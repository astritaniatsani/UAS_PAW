...
if(isset($_POST['tambahbtn'])){
	if(!$_POST['nimmahasiswatxt']){
			...
			$sql = mysqli_query($koneksi,"INSERT INTO rincian_surat(no_surat,nm_mahasiswa,nim_mahasiswa,semester,jurusan,tanggal_kp,tempat_kp,pejabat) VALUES ('$_POST[nosurattxt]','$_POST[nmmahasiswatxt]','$_POST[semestertxt]','$_POST[jurusantxt]','$_POST[tanggalkp]','$_POST[tempatkptxt]','$_POST[pejabattxt]')");
		...
		if ($record>=1){
			...
			$update = mysql_query("UPDATE surat_kp set nama='$_POST[nama]', tgl_kp='$_POST[tgl_kp]',tgl_selesaikp='$tgl_Selesaikp',tgl_sap='$tgl_sap',pejabat='$pejabat' where no_surat='$_POST[no_surat]'");
