			...
			<div class="social grid">
					<div class="grid-info">
						<div class="alert alert-success" role="alert">
									<strong>
                                    <h1>Assalamu'alaikum, Admin <?php echo $_SESSION['username']; ?> :)</h1> Selamat Datang!</strong> 
									Di Aplikasi Pembuatan Surat Akademik Fakultas Sains dan Teknologi. <p>
									Disini, Anda dapat mengontrol segala aktifitas yang berhubungan dengan Surat Akademik Fakultas Sains dan Teknologi.
								</div>
						<div class="clearfix"> </div>
					</div>
			</div>
