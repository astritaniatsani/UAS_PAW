...
?>	
		<tr>
            ...
            <a href="rincian_skl.php?no_surat=<?php echo $row['no_surat_lulus']; ?>" title="Rincian Data"><img src="../../images/ubah.png" width="15" height="15" /></a> |
<a href="hapus_skl.php?no_surat=<?php echo $row['no_surat_lulus']; ?>" title="Hapus Data"><img src="../../images/hapus.png" width="15" height="15" /></a>            
            </td>
        </tr>
		<?php $no++;}?>
