...
<!DOCTYPE html>
<head>
<title>SKL : Surat Keterangan Lulus Sains dan Teknologi</title>
...
<nav class="main-menu">
	...
	<section class="wrapper scrollable">
		...
		<section class="title-bar">
			<div class="logo">
				<h1><a href="index.html"><img src="images/logo.png" alt="" />SKL</a></h1>
			</div>
		...
		<!-- footer -->
		<div class="footer">
			<p>© 2018, SKL : Surat Keterangan Lulus</p>
		</div>
		<!-- //footer -->
	</section>
