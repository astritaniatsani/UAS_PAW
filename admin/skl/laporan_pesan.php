...
<form id="form1" name="form1" method="post" action="laporan_cetak.php?no_surat=<?php echo $row['no_surat']; ?>" target="new">
  <br><table width="800" height="47" border="0" align="center" cellpadding="2" cellspacing="0" bgcolor="#FFFFFF">
    <tr>
      <td width="700" align="left" valign="middle" bgcolor="#9D0000" scope="col"><font color="#FFFFFFF" face="Goudy Old Style" size="3"><strong>DATA SURAT KETERANGAN LULUS PERIODE :
 <input name="tglmulaitxt" type="text" id="tglmulaitxt" value="<?php echo $_POST['tglmulai'] ?>" size="10" readonly="readonly" />
  ...
  <table width="800" border="0" align="center" cellpadding="4" cellspacing="0">
    ...
    <?php
$no=1;
$tgl1 = substr($_POST['tglskl'],6,4)."-".substr($_POST['tglskl'],3,2)."-". substr($_POST['tglskl'],0,2); 		
$sql = "select * from surat_skl where tgl_skl >='$tgl1' and tgl_skl <='$tgl2' order by id desc";
$proses = mysql_query($sql);
while ($record = mysql_fetch_array($proses))
{
$tgl = substr($record['tgl_skl'],8,2)."-".substr($record['tgl_skl'],5,2)."-". substr($record['tgl_skl'],0,4); 		
?>
    <tr>
      ...
      <td align="center" scope="col" bgcolor="#FFFFFF"><?php echo $record['ipk'] ?></td>
