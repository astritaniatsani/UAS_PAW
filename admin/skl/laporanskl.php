...
<tr>
  <th align="left" valign="middle" bgcolor="#9D0000" scope="col"><font color="#FFFFFF" face="Goudy Old Style" size="4"><center><b>LAPORAN SURAT LULUS</b></th>
</tr>
</table><br>
  <table width="350" border="0" align="center" cellpadding="2" cellspacing="2">
    <tr>
      <td width="109" scope="col">LULUS</td>
      <td width="8" scope="col">:</td>
      <td width="213" scope="col"><input name="tglskl" type="text" id="tglskl" value="<?php echo date('d-m-Y') ?>" size="6" maxlength="10" readonly /></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
