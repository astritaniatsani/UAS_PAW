...
$query = "select * from ruang where kd_ruang='$kd_ruang'";
...
if(isset($_POST['submit'])){
	...
	$query=mysql_query("update ruang set nm_ruang='$nm_ruang', kapasitas='$kapasitas' where kd_ruang='$kd_ruang'");
							...
							<div class=" form-grids form-grids-right">
								<div class="widget-shadow " data-example-id="basic-forms"> 
									<div class="form-title">
										<h4>Form  Input Edit Data Ruang :</h4>
									</div>
									<div class="form-body">
										<form class="form-horizontal" action="#" method="post"> 
											<div class="form-group"> 
												<label for="inputEmail3" class="col-sm-2 control-label">Kode Ruaang</label> 
												<div class="col-sm-9"> 
													<input type="nama" name="kd_ruang" class="form-control" id="nama"  value="<?php echo $buff['kd_ruang']; ?>"> 
												</div> 
									</div> 
                                    <div class="form-group"> 
												<label for="inputEmail3" class="col-sm-2 control-label">Nama Ruang</label> 
												<div class="col-sm-9"> 
													<input type="username" name="nm_ruang" class="form-control" id="username" placeholder="Username" value="<?php echo $buff['nm_ruang']; ?>" > 
												</div> 
											</div> 
											<div class="form-group"> 
												<label for="inputPassword3" class="col-sm-2 control-label">Kapasitas</label> 
												<div class="col-sm-9"> 
													<input type="text" name="kapasitas" class="form-control" id="password" placeholder="Password" value="<?php echo $buff['kapasitas']; ?>"> 
												</div> 
											</div> 
